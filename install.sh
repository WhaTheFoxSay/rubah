...
RELEASE_URL="https://github.com/${REPO}/releases/download/v0.2.0/${BINARY_NAME}"
ARM64_FALLBACK_URL="https://github.com/${REPO}/releases/download/v0.2.0/rubah-${OS}-arm64"
