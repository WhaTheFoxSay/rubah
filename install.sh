...
RELEASE_URL="https://github.com/${REPO}/releases/download/v0.1.8/${BINARY_NAME}"
ARM64_FALLBACK_URL="https://github.com/${REPO}/releases/download/v0.1.8/rubah-${OS}-arm64"
