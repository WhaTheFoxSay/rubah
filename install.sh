...
RELEASE_URL="https://github.com/${REPO}/releases/download/v0.1.9/${BINARY_NAME}"
ARM64_FALLBACK_URL="https://github.com/${REPO}/releases/download/v0.1.9/rubah-${OS}-arm64"
