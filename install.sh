...
RELEASE_URL="https://github.com/${REPO}/releases/download/v0.1.7/${BINARY_NAME}"
ARM64_FALLBACK_URL="https://github.com/${REPO}/releases/download/v0.1.7/rubah-${OS}-arm64"
